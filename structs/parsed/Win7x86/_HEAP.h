...
struct _HEAP {
	...
	voidstruct Ptr32	HeaderValidateCopy;
	uint16_t	NextAvailableTagIndex;
	uint16_t	MaximumTagIndex;
	struct _HEAP_TAG_ENTRYstruct Ptr32	TagEntries;
	...
	voidstruct Ptr32	BlocksIndex;
	voidstruct Ptr32	UCRIndex;
	struct _HEAP_PSEUDO_TAG_ENTRYstruct Ptr32	PseudoTagEntries;
	struct _LIST_ENTRY	FreeLists;
	struct _HEAP_LOCKstruct Ptr32	LockVariable;
	struct longstruct Ptr32	CommitRoutine;
	voidstruct Ptr32	FrontEndHeap;
