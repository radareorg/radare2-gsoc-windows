...
struct _KPRCB {
	...
	struct _KTHREADstruct Ptr32	CurrentThread;
	struct _KTHREADstruct Ptr32	NextThread;
	struct _KTHREADstruct Ptr32	IdleThread;
	...
	struct _KTHREADstruct Ptr32	NpxThread;
	...
	struct _KNODEstruct Ptr32	ParentNode;
	...
	voidstruct Ptr32	IpiFrame;
	uint8_t	PrcbPad3[52];
	voidstruct Ptr32	CurrentPacket[3];
	uint32_t	TargetSet;
	voidstruct Ptr32	WorkerRoutine;
	uint32_t	IpiFrozen;
	uint8_t	PrcbPad4[40];
	uint32_t	RequestSummary;
	struct _KPRCBstruct Ptr32	SignalDone;
	...
	voidstruct Ptr32	ChainedInterruptList;
	...
	voidstruct Ptr32	WheaInfo;
	voidstruct Ptr32	EtwSupport;
	struct _SLIST_HEADER	InterruptObjectPool;
	struct _SLIST_HEADER	HypercallPageList;
	voidstruct Ptr32	HypercallPageVirtual;
	voidstruct Ptr32	VirtualApicAssist;
	uint64_tstruct Ptr32	StatisticsPage;
	voidstruct Ptr32	RateControl;
	...
	struct _CONTEXTstruct Ptr32	Context;
	uint32_t	ContextFlags;
	struct _XSAVE_AREAstruct Ptr32	ExtendedState;
	struct _KINTERRUPTstruct Ptr32	VectorToInterruptObject[208];
